  ...
  const menuSections = [
    {
      ...
      items: [
        ...
        },
        {
            ...
            icon: "headset-outline" as any,
            onPress: () =>
              router.navigate("./CustomerSupport"),
          },
      ],
    },
    {
      ...
      items: [
        {
          ...
          onPress: () => Alert.alert("Addresses", "Feature coming soon"),
        },
        {
      ...
      items: [
        {
          ...
          onPress: () => router.navigate("./PaymentMethods"),
        },
        {
      ...
      <View style={styles.quickActions}>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              "Wallet",
              "The feature is not available for now, stay tuned for more information!"
            )
          }
        >
          <Ionicons
            ...
            >
              <View style={styles.menuLeft}>
                <Ionicons
                  name={item.icon}
                  size={RFValue(20)}
                  color={'color' in item ? item.color : themeColors.accent}
                />
                <View style={styles.menuTextContainer}>
                  <Text
                    style={[
                      styles.menuTitle,
                      'color' in item ? { color: item.color } : { color: themeColors.text },
                    ]}
                  >
                    {item.title}
                  </Text>
